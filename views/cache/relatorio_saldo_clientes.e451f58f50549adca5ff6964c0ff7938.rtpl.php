      		...
      		<div class="row">  
				...
				<!-- coluna 1 da esquerda início -->
	      		<div class="col-md-6 mb-5">
	      			<!-- form inicio -->
	      			<form action="/recebimento" method="get">
						<div class="form-row">
					    	<div class="col-md-12">
					  	...
					  	<table class="table table-hover table-dark">
							  ...
							  <tbody>
							    ...
							    <tr>							      
							      ...
							      <td>
							      	<a href="/recebimento-receber?id_cli=<?php echo $value1->getCli_pk_int(); ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">
