	    	...
	    	<!-- row inicio -->
      		<div class="row">  
      			<div class="col-md-12 mx-auto">     	
					<h2 class="text-center mb-5">Venda<?php echo htmlspecialchars( $teste, ENT_COMPAT, 'UTF-8', FALSE ); ?></h2>
	      	    <!-- Título da página fim -->  
	      		</div>   	
				<!-- coluna 1 da esquerda início -->
	      		<div class="col-md-6 mb-5">
	      			<!-- form inicio -->
	      			<form action="/?app=venda&" method="get">
						<div class="form-row">
					    	<div class="col-md-12">
					  	...
					  	<table class="table table-hover table-dark">
							  ...
							  <?php $counter1=-1;  if( isset($arrayclientes) && ( is_array($arrayclientes) || $arrayclientes instanceof Traversable ) && sizeof($arrayclientes) ) foreach( $arrayclientes as $key1 => $value1 ){ $counter1++; ?>
							    ...
							    <tr>							      
							      ...
							      <td>
							      	<a href="/venda-vender?id_cli=<?php echo htmlspecialchars( $value1->getCli_pk_int(), ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">
