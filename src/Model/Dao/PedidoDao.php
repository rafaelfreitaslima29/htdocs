...
class PedidoDao extends AbstractDao
{
     ...
     * @desc M�todo que recebe um objeto do tipo Pedido com o campo do Id do cliente preenchido, para criar um registro no banco de dados.
     */
     ...
     * @desc M�todo que recebe um objeto do tipo Pedido com os campos idPk, pedido_estado e Pedido_saldo_total preenchido, para alterar um registro do pedido no banco de dados.
     */
     ...
     * @desc M�todo que recebe um objeto do tipo Pedido com o campo idPk preenchido, que apaga o registro do pedido no banco de dados.
     */
     ...
     * @desc M�todo que recebe um objeto do tipo Pedido com os campos idPk preenchido, para retornar um objeto do tipo Pedido de um registro da tabela pedido do banco de dados.
     */    
     ...
     * @desc M�todo que retorna um array de objetos do tipo Pedido, dos registros da tabela pedido do banco de dados.
     */
