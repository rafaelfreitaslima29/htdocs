...
class RecebimentoDao extends AbstractDao
{
    ...
    /**
     * {@inheritDoc}
     * @desc M�todo que recebe um objeto do tipo Recebimento com os atributoscliente_fk, valor e observa��o preenchidos.
     */
...
/*    
  ...
  */
    ...
    /**
     * {@inheritDoc}
     * @desc M�todo que recebe um objeto do tipo Recebimento completo e que necessita de um objeto Produto como um de seus atributos para seu preenchimento, para realizar a altera��o de seus registros.
     */
    ...
    /**
     * {@inheritDoc}
     * @desc M�todo que recebe o ID PK de um objeto do tipo Recebimento preenchido, que apaga o registro no banco de dados.
     */
    ...
    /**
     * {@inheritDoc}
     * @desc M�todo que recebe o ID PK de um objeto do tipo Recebimentos preenchido, que retorna os registro da linha no banco de dados em forma de um objeto ListaPedido.
     */
    ...
    /**
     * {@inheritDoc}
     * @desc M�todo que retorna um array de objetos do tipo Recebimento, dos registros da tabela Recebimento do banco de dados.
     */
    ...
    /**
     * {@inheritDoc}
     * @desc M�todo que retorna um array de objetos do tipo Recebimentoo ele recebe como parametro um objeto do tipo Recebimento com com seu FK preenchido, dos registros da tabela ListaPedido do banco de dados.
     */
